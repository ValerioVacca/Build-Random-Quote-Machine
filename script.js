...
function stringToClickToTweetURL(string) {
  
  // Convert to Click to Tweet URL
  let stringConvert = string.split(" ").join("%20").split("@").join("%40").split("!").join("%21");

  // Put 'Click to Tweet' URL suffix at the begining
  let finalString = "https://twitter.com/intent/tweet?text=" + stringConvert;
